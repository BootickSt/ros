...
def generate_launch_description():
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package='my_traektoria').find('my_traektoria')
    #pkg_share = get_package_share_directory('task3')
    ...
    circle_mover = Node(
        package='my_traektoria',
        executable='my_traektoria',
        name='circle_mover',
        parameters=[
        ]
    )
