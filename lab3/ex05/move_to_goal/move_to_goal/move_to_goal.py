...
class MoveToGoal(Node):
    ...
    def control_loop(self):
        ...
        # Вычисляем ошибку положения и ориентации
        ...
        # Создаем сообщение Twist для отправки черепахе
        twist = Twist()
        ...
        if distance > self.tolerance:
            ...
            # Поворачиваемся на окончательную ориентацию
...
def main(args=None):
    ...
    rclpy.spin(move_to_goal)  # Используем обычный спин вместо spin_until_future_complete
